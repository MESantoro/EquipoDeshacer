...
export function Usuarios(){
    ...
    const cambiar_estado = async (e, id_usuario, estado_actual)=>{
        ...
        const mjs = (estado_actual=="O")?"BAJA":"ALTA";
        Swal.fire({
            title: 'Esta seguro?',
            text: "VAS "+mjs+" A UN USUARIO!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            cancelButtonText: 'NANINGALA',
            confirmButtonText: 'OK METELE!'
          }).then((result) => {
            if (result.isConfirmed) {
                ...
                .then((respuesta) => {
                    if(respuesta.status){
                        ...
                        if(id_usuario==datos_usuario.id_usuario && actualizar=="X"){
    ...
    const resetPass = async (e, id_usuario)=>{
        ...
        Swal.fire({
            title: 'Esta seguro?',
            text: "VA A BLANQUEAR LA CLAVE DE UN USUARIO!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            cancelButtonText: 'NANINGALA ',
            confirmButtonText: 'SEGURICIMO!'
          }).then((result) => {
            if (result.isConfirmed) {
                console.log('mi id_usuario es-->',id_usuario)
